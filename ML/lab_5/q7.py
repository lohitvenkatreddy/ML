...
plt.tight_layout()
plt.show()
# Elbow Method: Used to find the optimal number of clusters (k) in K-Means.
# Idea: Plot 'inertia' (sum of squared distances to the nearest cluster center) vs. k.
# The 'elbow point' where inertia drops slowly afterwards is the best k (balance between fit & simplicity).
